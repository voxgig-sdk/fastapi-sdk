# Fastapi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FastapiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FastapiSDK(...) and FastapiSDK.test(...) become
#      FastapiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fastapi_sdk"
_SDK_CLASS = "FastapiSDK"
