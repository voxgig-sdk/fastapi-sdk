...
from fastapi_sdk.core.response import FastapiResponse
from fastapi_sdk.core.operation import FastapiOperation
from fastapi_sdk.core.error import FastapiError
from fastapi_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FastapiSDK.test(None, None)
        ...
        class TestInitFeature(FastapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FastapiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FastapiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FastapiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FastapiSDK.test(None, setup_opts)
