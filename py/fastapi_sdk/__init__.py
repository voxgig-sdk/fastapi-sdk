...
from fastapi_sdk.utility import register

# Load features
from fastapi_sdk.feature.base_feature import FastapiBaseFeature
from fastapi_sdk.features import _has_feature, _make_feature
...
class FastapiSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FastapiUtility()
        self._utility = utility

        from fastapi_sdk.config import shared_config
    ...
    def get_utility(self):
        return FastapiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FastapiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def IndexGet(self, data=None) -> "IndexGetEntity":
        ...
        from fastapi_sdk.entity.index_get_entity import IndexGetEntity
