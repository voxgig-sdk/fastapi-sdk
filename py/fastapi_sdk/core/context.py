...
from fastapi_sdk.core.helpers import get_ctx_prop, to_map
...
class FastapiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, FastapiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FastapiError(code, msg, self)
