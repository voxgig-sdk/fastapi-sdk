...
local RobotEntity = {}
RobotEntity.__index = RobotEntity


function RobotEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RobotEntity)
  self._name = "robot"
  self._client = client
...
function RobotEntity:get_name()
  return self._name
end


function RobotEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RobotEntity.new(self._client, opts)
end
...
function RobotEntity:mark_deleted()
  self._deleted = true
end


function RobotEntity:deleted()
  return true == self._deleted
end


function RobotEntity:data_set(args)
  if args ~= nil then
...
function RobotEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RobotEntity:match_set(args)
  if args ~= nil then
...
function RobotEntity:match_get()
...
function RobotEntity:stream(action, args, callopts)
...
---@param reqmatch RobotLoadMatch
---@param ctrl? table
---@return Robot
---@return string? err
function RobotEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function RobotEntity:_run_op(ctx, post_done)
  local utility = self._utility
