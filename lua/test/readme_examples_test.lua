...
-- data to return.
local TEST_SEED = '{ entity = { ["index_get"] = { ["test01"] = { id = "test01" } }, ["iprank"] = { ["test01"] = { id = "test01" } }, ["json"] = { ["test01"] = { id = "test01" } }, ["robot"] = { ["test01"] = { id = "test01" } }, ["simple"] = { ["test01"] = { id = "test01" } }, ["table"] = { ["test01"] = { id = "test01" } } } }'
