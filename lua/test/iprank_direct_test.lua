...
describe("IprankDirect", function()
  it("should direct-load-iprank", function()
    local setup = iprank_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-iprank", setup.live and "live" or "unit")
...
function iprank_direct_setup(mockres)
