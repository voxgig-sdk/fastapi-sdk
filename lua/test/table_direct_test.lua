...
describe("TableDirect", function()
  it("should direct-load-table", function()
    local setup = table_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-table", setup.live and "live" or "unit")
