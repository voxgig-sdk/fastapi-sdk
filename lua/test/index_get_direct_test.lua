...
describe("IndexGetDirect", function()
  it("should direct-load-index_get", function()
    local setup = index_get_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-index_get", setup.live and "live" or "unit")
...
function index_get_direct_setup(mockres)
