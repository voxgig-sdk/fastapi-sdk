...
describe("RobotDirect", function()
  it("should direct-load-robot", function()
    local setup = robot_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-robot", setup.live and "live" or "unit")
...
function robot_direct_setup(mockres)
