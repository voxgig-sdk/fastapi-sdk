...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/fastapi` | `npm install @voxgig-sdk/fastapi` |
| Python | `voxgig-sdk-fastapi` | `pip install voxgig-sdk-fastapi` |
| PHP | `voxgig-sdk/fastapi` | `composer require voxgig-sdk/fastapi` |
| Golang | `github.com/voxgig-sdk/fastapi-sdk/go` | `go get github.com/voxgig-sdk/fastapi-sdk/go` |
| Ruby | `voxgig-sdk-fastapi` | `gem install voxgig-sdk-fastapi` |
| Lua | `voxgig-sdk-fastapi` | `luarocks install voxgig-sdk-fastapi` |
