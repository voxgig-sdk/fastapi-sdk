...
Learn more about FastAPI at [realip.cc](https://realip.cc).
...
This SDK exposes the API as a small set of **semantic entities** — IndexGet, Iprank, Json, Robot, Simple and Table — that you
