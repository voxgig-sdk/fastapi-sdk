...
function envOverride(m) {
    if ('TRUE' === process.env.FASTAPI_TEST_LIVE ||
        'TRUE' === process.env.FASTAPI_TEST_OVERRIDE) {
    ...
    m.FASTAPI_TEST_EXPLAIN = process.env.FASTAPI_TEST_EXPLAIN || m.FASTAPI_TEST_EXPLAIN;
    return m;
}
