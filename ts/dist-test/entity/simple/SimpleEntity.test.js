...
(0, node_test_1.describe)('SimpleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.live) {
            return (0, live_entity_1.runLiveEntity)(setup, { "active": true, "alias": { "field": {} }, "fields": [], "name": "simple", "op": { "load": { "input": "data", "name": "load", "points": [{ "active": true, "args": {}, "contract": { "id": "GET /simple", "json": "{\"operationId\":\"simple_simple_get\",\"parameters\":[],\"protocol\":\"http\",\"responses\":{\"200\":{\"content\":{\"application/json\":{\"schema\":{}}},\"description\":\"Successful Response\"}},\"securitySource\":\"unspecified\"}", "source": "openapi3", "version": 1 }, "kind": "http", "method": "GET", "orig": "/simple", "segments": [{ "lit": "simple" }], "select": {}, "transform": { "req": "`reqdata`", "res": "`body`" }, "index$": 0 }], "key$": "load" } }, "relations": { "ancestors": [] }, "key$": "simple", "name__orig": "simple", "Name": "Simple", "name_": "simple", "name-": "simple", "NAME": "SIMPLE", "index$": 4 }, { "active": true, "entity": "simple", "key$": "BasicSimpleFlow", "kind": "basic", "name": "BasicSimpleFlow", "param": {}, "step": [{ "active": true, "data": {}, "input": { "ref": "simple_ref01", "srcdatavar": "simple_ref01_data", "suffix": "_dt0" }, "match": {}, "op": "load", "spec": [], "valid": [{ "apply": "TextFieldMark", "def": { "mark": "Mark01-simple_ref01" } }], "index$": 0 }] }, 'Simple');
        }
...
function basicSetup(extra) {
    ...
    idmap = env['FASTAPI_TEST_SIMPLE_ENTID'];
    const live = 'TRUE' === env.FASTAPI_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['FASTAPI_TEST_SIMPLE_ENTID'];
