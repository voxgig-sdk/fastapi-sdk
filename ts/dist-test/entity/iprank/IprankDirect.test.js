...
(0, node_test_1.describe)('IprankDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-iprank', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-iprank', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FASTAPI_TEST_IPRANK_ENTID'];
...
//# sourceMappingURL=IprankDirect.test.js.map