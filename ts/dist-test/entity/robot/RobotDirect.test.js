...
(0, node_test_1.describe)('RobotDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-robot', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-robot', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FASTAPI_TEST_ROBOT_ENTID'];
...
//# sourceMappingURL=RobotDirect.test.js.map