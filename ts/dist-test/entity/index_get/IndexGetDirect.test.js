...
(0, node_test_1.describe)('IndexGetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-index_get', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-index_get', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FASTAPI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FastapiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FASTAPI_TEST_INDEX_GET_ENTID'];
    ...
    const client = new __1.FastapiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IndexGetDirect.test.js.map