...
class FastapiCacheFeature extends FastapiBaseFeature
{
    ...
    private function _through(FastapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
