...
// Fastapi SDK clienttrack feature
...
class FastapiClienttrackFeature extends FastapiBaseFeature
{
    ...
    public function PostConstruct(FastapiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Fastapi-SDK';
