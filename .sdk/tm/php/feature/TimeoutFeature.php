...
class FastapiTimeoutFeature extends FastapiBaseFeature
{
    ...
    private function _with_timeout(FastapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FastapiContext $_ctx, float $ms): void
    {
        $client = $this->client;
