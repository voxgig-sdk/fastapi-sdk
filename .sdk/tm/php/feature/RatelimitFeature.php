...
class FastapiRatelimitFeature extends FastapiBaseFeature
{
    ...
    private function _acquire(FastapiContext $ctx): void
    {
    ...
    private function _track(FastapiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
