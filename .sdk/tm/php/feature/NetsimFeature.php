...
class FastapiNetsimFeature extends FastapiBaseFeature
{
    ...
    private function _simulate(FastapiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(FastapiContext $ctx, array $applied): void
    {
        $client = $this->client;
