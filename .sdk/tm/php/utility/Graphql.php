...
class FastapiGraphql
{
    ...
    // equivalent.
    public static function body(FastapiContext $ctx): mixed
    {
    ...
    public static function errors(FastapiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
