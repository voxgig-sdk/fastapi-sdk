...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FastapiOmni.make_runner(TEST_JSON_FILE, FastapiSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FastapiOmni.errify(err)
    end
