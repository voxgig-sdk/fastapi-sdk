...
|---|---|---|
| `ts/` | @voxgig-sdk/fastapi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fastapi-sdk \
      --repository voxgig-sdk/fastapi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fastapi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fastapi-sdk --id=<id>` removes it.
