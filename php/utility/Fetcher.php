...
class FastapiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FastapiSDK/1.0)';
    ...
    public static function call(FastapiContext $ctx, string $fullurl, array $fetchdef): array
    {
