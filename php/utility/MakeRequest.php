...
// Fastapi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FastapiMakeRequest
{
    public static function call(FastapiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FastapiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FastapiResponse($fetched);
        } else {
