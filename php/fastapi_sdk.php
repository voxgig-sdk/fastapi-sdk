...
class FastapiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = FastapiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = FastapiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!FastapiFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, FastapiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return FastapiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = FastapiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = FastapiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = FastapiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new FastapiError($op . "_allow",
                "FastapiSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = FastapiHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new FastapiError("graphql_error",
                "FastapiSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function IndexGet($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_index_get === null) {
                $this->_index_get = new IndexGetEntity($this, null);
            }
            return $this->_index_get;
        }
        return new IndexGetEntity($this, $data);
    }
    ...
    public function Iprank($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_iprank === null) {
                $this->_iprank = new IprankEntity($this, null);
            }
            return $this->_iprank;
        }
        return new IprankEntity($this, $data);
    }
    ...
    public function Robot($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_robot === null) {
                $this->_robot = new RobotEntity($this, null);
            }
            return $this->_robot;
        }
        return new RobotEntity($this, $data);
    }
