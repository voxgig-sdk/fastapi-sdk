...
class RobotEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RobotEntity($this->_client, $opts);
    }

    /**
     * @param Robot|array $args Robot data (assoc-array) to store.
     */
    ...
    /**
     * @return Robot|array The current Robot data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Robot fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Robot fields).
     */
     ...
     * Load a single Robot.
     *
     * @param RobotLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RobotLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Robot|array The loaded Robot as an assoc-array at the
