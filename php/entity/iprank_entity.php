...
class IprankEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IprankEntity($this->_client, $opts);
    }

    /**
     * @param Iprank|array $args Iprank data (assoc-array) to store.
     */
    ...
    /**
     * @return Iprank|array The current Iprank data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Iprank fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Iprank fields).
     */
    ...
    /**
     * Load a single Iprank.
     *
     * @param IprankLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IprankLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iprank|array The loaded Iprank as an assoc-array at the
