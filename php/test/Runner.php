...
class FastapiTestRunner
{
    ...
    {
        $live = self::getenv('FASTAPI_TEST_LIVE');
        $override = self::getenv('FASTAPI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FASTAPI_TEST_EXPLAIN');
...
class_alias('FastapiTestRunner', 'Runner');
class_alias('FastapiHelpers', 'Helpers');
