...
class IndexGetDirectTest extends TestCase
{
    public function test_direct_load_index_get(): void
    {
        $setup = index_get_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-index_get", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
