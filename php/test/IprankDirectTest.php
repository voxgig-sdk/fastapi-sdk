...
class IprankDirectTest extends TestCase
{
    public function test_direct_load_iprank(): void
    {
        $setup = iprank_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-iprank", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
