...
class JsonEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set FASTAPI_TEST_JSON_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function json_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("FASTAPI_TEST_JSON_ENTID");
