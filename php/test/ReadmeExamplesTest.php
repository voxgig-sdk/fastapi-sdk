...
// Fastapi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FastapiSDK::test)
...
{
    private const SDK_CLASS = 'FastapiSDK';
    ...
    private const SDK_BASE = 'fastapi_sdk';
