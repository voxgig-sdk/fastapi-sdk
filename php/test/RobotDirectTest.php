...
class RobotDirectTest extends TestCase
{
    public function test_direct_load_robot(): void
    {
        $setup = robot_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-robot", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
