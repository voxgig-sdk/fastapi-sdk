...
class FastapiStreamingFeature extends FastapiBaseFeature
{
    ...
    private function _iterate(FastapiResult $result): \Generator
    {
    ...
    private function _streamable(FastapiContext $ctx): bool
    {
