...
class FastapiRbacFeature extends FastapiBaseFeature
{
    ...
    private function _required(FastapiContext $ctx): ?string
    {
    ...
    private function _reject(FastapiContext $ctx, string $required): void
    {
    ...
    private function _track(FastapiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
