...
class FastapiProxyFeature extends FastapiBaseFeature
{
    ...
    public function init(FastapiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FastapiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
