...
// Fastapi SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FastapiTestFeature extends FastapiBaseFeature
{
    ...
    public function init(FastapiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FastapiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FastapiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FastapiContext $ctx, $op, $args): array
    {
