...
The PHP SDK for the Fastapi API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->IndexGet(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->Fastapi(null)->load(
    ["id" => "test01"], null
);
