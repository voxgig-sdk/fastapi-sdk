...
The PHP SDK for the Fastapi API — an entity-oriented client using PHP conventions.
...
```
php/
├── fastapi_sdk.php          -- Main SDK class
...
The main class (`fastapi_sdk.php`) exports the SDK class
