...
class TableEntity
  ...
  # @return [Table, Hash] the current Table data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Table fields)
  def match_get
  ...
  # Load a single Table.
  #
  # @param reqmatch [TableLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Table.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Table, Hash] the loaded Table; raises FastapiError on failure
