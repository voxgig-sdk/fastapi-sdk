...
class RobotEntity
  ...
  # @return [Robot, Hash] the current Robot data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Robot fields)
  def match_get
  ...
  # Load a single Robot.
  #
  # @param reqmatch [RobotLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Robot.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Robot, Hash] the loaded Robot; raises FastapiError on failure
