...
class IprankEntity
  ...
  # @return [Iprank, Hash] the current Iprank data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Iprank fields)
  def match_get
  ...
  #
  # @param reqmatch [IprankLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Iprank.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Iprank, Hash] the loaded Iprank; raises FastapiError on failure
