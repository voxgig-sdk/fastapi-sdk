...
module FastapiTestRunner
  ...
  def self.env_override(m)
    live = getenv("FASTAPI_TEST_LIVE")
    override = getenv("FASTAPI_TEST_OVERRIDE")
    ...
    explain = getenv("FASTAPI_TEST_EXPLAIN")
    m["FASTAPI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
