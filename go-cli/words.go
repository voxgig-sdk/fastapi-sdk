...
func registerSDKWords(r *eng.Registry, client *sdk.FastapiSDK) {
...
func runOp(client *sdk.FastapiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
