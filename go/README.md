...
The Golang SDK for the Fastapi API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/fastapi-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/fastapi-sdk=../path/to/github.com/voxgig-sdk/fastapi-sdk
```
...
```
github.com/voxgig-sdk/fastapi-sdk/
...
The root package (`github.com/voxgig-sdk/fastapi-sdk`) re-exports everything needed
