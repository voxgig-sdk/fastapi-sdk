...
func plClient(t *testing.T, sdkopts map[string]any) (*sdk.FastapiSDK, *sdk.Utility) {
	t.Helper()
	client := sdk.TestSDK(nil, sdkopts)
	return client, client.GetUtility()
}

func plCtx(client *sdk.FastapiSDK, utility *sdk.Utility, ctrl map[string]any) *sdk.Context {
