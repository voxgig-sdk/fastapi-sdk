...
const testSeed = `map[string]any{"entity": map[string]any{"index_get": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "iprank": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "json": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "robot": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "simple": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "table": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
