...
func NewRobotEntity(client *core.FastapiSDK, entopts map[string]any) *RobotEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RobotEntity) GetName() string { return e.name }
...
func (e *RobotEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RobotEntity) Deleted() bool {
	return e.deleted
}


func (e *RobotEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRobotEntity(e.client, opts)
}

func (e *RobotEntity) Data(args ...any) any {
...
func (e *RobotEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Robot; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RobotEntity) DataTyped(data ...Robot) Robot {
	if len(data) > 0 {
		return typedFrom[Robot](e.Data(asMap(data[0])))
	}
	return typedFrom[Robot](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Robot (all fields
// optional at the wire level).
func (e *RobotEntity) MatchTyped(match ...Robot) Robot {
	if len(match) > 0 {
		return typedFrom[Robot](e.Match(asMap(match[0])))
	}
	return typedFrom[Robot](e.Match())
}
...
func (e *RobotEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RobotEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RobotLoadMatch and returns an Robot. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RobotEntity) LoadTyped(reqmatch RobotLoadMatch, ctrl map[string]any) (Robot, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Robot{}, err
	}
	return typedFrom[Robot](res), nil
}



func (e *RobotEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RobotEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RobotEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RobotEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RobotEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
