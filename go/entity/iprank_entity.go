...
type IprankEntity struct {
	name    string
	client  *core.FastapiSDK
...
func NewIprankEntity(client *core.FastapiSDK, entopts map[string]any) *IprankEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IprankEntity) GetName() string { return e.name }
...
func (e *IprankEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IprankEntity) Deleted() bool {
	return e.deleted
}


func (e *IprankEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIprankEntity(e.client, opts)
}

func (e *IprankEntity) Data(args ...any) any {
...
func (e *IprankEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Iprank; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IprankEntity) DataTyped(data ...Iprank) Iprank {
	if len(data) > 0 {
		return typedFrom[Iprank](e.Data(asMap(data[0])))
	}
	return typedFrom[Iprank](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Iprank (all fields
// optional at the wire level).
func (e *IprankEntity) MatchTyped(match ...Iprank) Iprank {
	if len(match) > 0 {
		return typedFrom[Iprank](e.Match(asMap(match[0])))
	}
	return typedFrom[Iprank](e.Match())
}
...
func (e *IprankEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IprankEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IprankLoadMatch and returns an Iprank. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *IprankEntity) LoadTyped(reqmatch IprankLoadMatch, ctrl map[string]any) (Iprank, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Iprank{}, err
	}
	return typedFrom[Iprank](res), nil
}



func (e *IprankEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IprankEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IprankEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IprankEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IprankEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
