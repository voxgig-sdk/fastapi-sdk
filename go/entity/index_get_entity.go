...
func NewIndexGetEntity(client *core.FastapiSDK, entopts map[string]any) *IndexGetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IndexGetEntity) GetName() string { return e.name }
...
func (e *IndexGetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IndexGetEntity) Deleted() bool {
	return e.deleted
}


func (e *IndexGetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIndexGetEntity(e.client, opts)
}

func (e *IndexGetEntity) Data(args ...any) any {
...
func (e *IndexGetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *IndexGetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IndexGetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *IndexGetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *IndexGetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IndexGetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IndexGetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
